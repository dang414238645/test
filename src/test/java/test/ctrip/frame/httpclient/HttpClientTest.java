...
public class HttpClientTest {
	...
	public void testAjax() throws ClientProtocolException, IOException{
		...
		HttpGet httpGet = new HttpGet("http://ihotel.elong.com/SearchDataWindow_Region.html?datatype=Region&keyword=aa&datalength=10");
		...
		httpGet.setHeader("Host", "ihotel.elong.com");
